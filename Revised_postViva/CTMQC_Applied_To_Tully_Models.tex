...
\end{enumerate}
of these \mremove{3}\madd{three} methods, method \mremove{3}\madd{three} was the most successful in reducing the norm drift in the Tully Models as can be seen in figure \ref{fig:NormConsCorr}.
\begin{figure}[ht]
