...
The diabatic propagation can be tested against the already tested adiabatic propagator using the Tully model Hamiltonian. The code should give the same results, given the same inputs. %To check this in figure \ref{fig:diab_prop_vs_adiab} the outputs of the simulations carried out in 
%\begin{figure}
%  \includegraphics[width=\textwidth]{./img/CTMQC/TullyModels/diab_vs_adiab_prop.png}
%  \caption{\label{fig:diab_prop_vs_adiab}The 4 Tully models simulated using equations \ref{eq:diabForces} and \ref{eq:diabMatEq}. The }
%\end{figure}
