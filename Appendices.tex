...
\begin{equation}
  |f(R)|^2 = \int^{\infty}_{-\infty} W(R, p) dp
\end{equation}
\begin{equation}
  |f(p)|^2 = \int^{\infty}_{-\infty} W(R, p) dR
\end{equation}
...
\begin{equation}
  |f(R)|^2 = \frac{2}{\mu \sqrt{\pi}} e^{- \frac{(R - R_0)^2}{\mu^2}}
\end{equation}
\begin{equation}
  |f(p)|^2 = \frac{2}{\frac{\hbar}{\mu} \sqrt{\pi}} e^{- \frac{\mu^2}{\hbar^2}(p - \ \hbar k_0)^2}
\end{equation}
